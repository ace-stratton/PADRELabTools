...
FOLDER_PATH = "file-sciencedownload11files"      # Folder containing the .bin files
MAPPING_CSV  = "FilenameDirectory_2504110022_Gen_20250416_125945.csv"  # Semicolon‑delimited mapping CSV
# =====================================================
