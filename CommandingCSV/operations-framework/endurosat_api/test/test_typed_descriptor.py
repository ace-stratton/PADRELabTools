...
from endurosat_api.models.typed_descriptor import TypedDescriptor  # noqa: E501
from endurosat_api.rest import ApiException

class TestTypedDescriptor(unittest.TestCase):
    """TypedDescriptor unit test stubs"""
    ...
    def make_instance(self, include_optional):
        """Test TypedDescriptor
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # model = endurosat_api.models.typed_descriptor.TypedDescriptor()  # noqa: E501
        if include_optional :
