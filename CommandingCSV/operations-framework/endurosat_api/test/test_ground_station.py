...
from endurosat_api.models.ground_station import GroundStation  # noqa: E501
...
class TestGroundStation(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        # model = endurosat_api.models.ground_station.GroundStation()  # noqa: E501
        if include_optional :
            return GroundStation(
                id = '01d11243-af60-46d3-ac8e-d7f4cc3c9104', 
                longitude = 23.4290789, 
                latitude = 42.4794107, 
                elevation = 1100, 
                antennas = [], 
                channels = [], 
                supported_protocols = [PassthroughProtocol, ESProtocol], 
                protocols = {}, 
                sockets = {}, 
                satellite_streams = {}, 
                user_streams = {}, 
